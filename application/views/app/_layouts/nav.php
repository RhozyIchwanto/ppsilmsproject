<li class="c-slidebar__item">
    <a href="<?php echo base_url('app/dashboard') ?>" class="c-slidebar__link <?php if($this->uri->segment(1)=="app" and empty($this->uri->segment(2)) or $this->uri->segment(2) == 'dashboard'){echo "is-active";}?>">
...
<li class="c-sidebar__item has-submenu <? if(strpos($this->uri->segment(2), "lms_") !== FALSE){ echo "is-open";}?>">
    <a href="#lms-submenu" class="c-sidebar__link collapsed" data-toggle="collapse" aria-expanded="false" aria-control="lms-sumbenu" >
        <i class="fa fa-caret-suqare-o-down u-mr xsmall"></i>Part of LMS
    </a>
    <ul class="c-sidebar__submenu collapse <?php if(strpost($this->uri->segment(2), "lms_") !== FALSE){echo "show;"}?>" id="lms-sumbenu">
        
        <li><a href="<?php echo base_url('app/lms_category') ?>" class="c-sidebar__link">
        Category
        ...
        <li><a href="<?php echo base_url('app/lms_template') ?>" class="c-sidebar__link">
        Template
        ...
        <li><a href="<?php echo base_url('app/lms_coupon') ?>" class="c-sidebar__link">
        Coupon
