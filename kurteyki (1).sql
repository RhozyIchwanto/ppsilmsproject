...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 09 Nov 2020 pada 09.11
...
--
-- Struktur dari tabel `tb_blog_post`
--
...
--
-- Dumping data untuk tabel `tb_blog_post`
--

INSERT INTO `tb_blog_post` (`id_post`, `id_user`, `title`, `permalink`, `image`, `time`, `updated`, `id_category`, `id_tags`, `content`, `description`, `views`, `status`) VALUES
...
--
-- Struktur dari tabel `tb_blog_post_category`
--

CREATE TABLE `tb_blog_post_category` (
  `id_post_category` int(255) NOT NULL,
  `name` varchar(255) NOT NULL,
  `slug` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data untuk tabel `tb_blog_post_category`
--

INSERT INTO `tb_blog_post_category` (`id_post_category`, `name`, `slug`) VALUES
(1, 'news', 'news');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_blog_post_comment`
--

CREATE TABLE `tb_blog_post_comment` (
  `id_post_comment` int(255) NOT NULL,
...
--
-- Struktur dari tabel `tb_blog_post_tags`
--

CREATE TABLE `tb_blog_post_tags` (
  `id_blog_tags` int(255) NOT NULL,
  `name` varchar(255) NOT NULL,
  `slug` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data untuk tabel `tb_blog_post_tags`
--

INSERT INTO `tb_blog_post_tags` (`id_blog_tags`, `name`, `slug`) VALUES
(1, 'berita', 'berita');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_blog_template`
--
...
--
-- Dumping data untuk tabel `tb_blog_template`
--

INSERT INTO `tb_blog_template` (`id_template`, `name`, `path`, `status`) VALUES
...
--
-- Struktur dari tabel `tb_blog_template_style`
--

CREATE TABLE `tb_blog_template_style` (
  `id_template_style` int(255) NOT NULL,
  `id_template` int(255) NOT NULL,
...
--
-- Dumping data untuk tabel `tb_blog_template_style`
--

INSERT INTO `tb_blog_template_style` (`id_template_style`, `id_template`, `type`, `name`, `file`, `status`) VALUES
...
--
-- Struktur dari tabel `tb_blog_template_widget`
--

CREATE TABLE `tb_blog_template_widget` (
  `id_template_widget` int(255) NOT NULL,
  `id_template` int(255) NOT NULL,
  `name` varchar(255) NOT NULL,
...
--
-- Dumping data untuk tabel `tb_blog_template_widget`
--

INSERT INTO `tb_blog_template_widget` (`id_template_widget`, `id_template`, `name`, `var`, `type`, `data_json`) VALUES
...
INSERT INTO `tb_jobs` (`id_jobs`, `name`, `payload`, `response`, `status`, `run_time`, `created`) VALUES
...
--
-- Struktur dari tabel `tb_lms_category`
--

CREATE TABLE `tb_lms_category` (
  `id_lms_category` int(255) NOT NULL,
  `name` varchar(255) NOT NULL,
  `slug` varchar(255) NOT NULL,
  `parent` int(255) NOT NULL,
  `time` datetime NOT NULL,
...
--
-- Dumping data untuk tabel `tb_lms_category`
--

INSERT INTO `tb_lms_category` (`id_lms_category`, `name`, `slug`, `parent`, `time`, `updated`, `icon`, `image`) VALUES
...
--
-- Struktur dari tabel `tb_lms_coupon`
--

CREATE TABLE `tb_lms_coupon` (
  `id_lms_coupon` int(11) NOT NULL,
...
--
-- Struktur dari tabel `tb_lms_courses`
--

CREATE TABLE `tb_lms_courses` (
  `id_lms_courses` int(255) NOT NULL,
  `id_user` int(255) NOT NULL,
  `title` mediumtext NOT NULL,
  `permalink` varchar(255) NOT NULL,
  `image` varchar(255) NOT NULL,
...
--
-- Dumping data untuk tabel `tb_lms_courses`
--

INSERT INTO `tb_lms_courses` (`id_lms_courses`, `id_user`, `title`, `permalink`, `image`, `description`, `faq`, `id_category`, `id_sub_category`, `time`, `updated`, `price`, `discount`, `views`, `status`) VALUES
(1, 2, 'Pengetahuan untuk menjadi manusia berbakat', 'ilmu-dari-adam-khoo', 'images/banner.png', '&lt;p&gt;materi ini saya ambil dari buku karya adam khoo yang berjudul i am gifted so are you, buku ini mengajarkan banyak hal bagaimana cara menjadi pribadi yang berbakat. didalam buku ini banyak sekali ilmu yang bisa diterapkan untuk pelajar, membangun keyakinan diri, cita-cita, mengatur waktu dan lain sebagainya.&lt;/p&gt;\r\n\r\n&lt;p&gt;didalam kursus ini hanya berisi ringkasan singkat dari buku yang ada.&amp;nbsp;materi yang saya sampaikan menggunakan gaya bahasa dari apa yang saya pahami, untuk mendapatkan informasi lebih lengkap tentang buku ini anda bisa membeli bukunya di toko buku.&lt;/p&gt;\r\n', '', '1', '3', '2020-04-11 16:53:44', '2020-05-03 15:44:54', 0, 0, 217, 'Published'),
(2, 2, 'Ilmu Finansial dari Building The Dream', 'ilmu-dari-building-the-dream', 'images/banner.png', '&lt;p&gt;Materi ini saya dapat dari sebuah grup pengembangan diri yang terkenal dengan nama btd atau building the dream, awal saya masuk grup ini adalah diundang seseorang melalui kontak whatsapp tahun 2017 lalu.&amp;nbsp;&lt;/p&gt;\r\n\r\n&lt;p&gt;materi yang saya sampaikan hanya ringkasan saja dari materi yang ada. jika anda tertarik ingin bergabung ke grup btd anda harus mengontak pengurusnya, sayangnya saya sudah tidak masuk grup tersebut karena nomor saya yang masuk grup tersebut sudah tidak aktif lagi.&lt;/p&gt;\r\n', '', '1', '2', '2020-04-11 22:19:25', '2020-04-16 08:07:19', 0, 0, 243, 'Published');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_lms_courses_lesson`
--

CREATE TABLE `tb_lms_courses_lesson` (
  `id_courses_lesson` int(255) NOT NULL,
...
--
-- Dumping data untuk tabel `tb_lms_courses_lesson`
--

INSERT INTO `tb_lms_courses_lesson` (`id_courses_lesson`, `id_courses`, `id_section`, `title`, `type`, `content`, `order`) VALUES
...
(10, 2, 8, 'Yaaaa', 'Text', '<p>aaa</p>\r\n', 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_lms_courses_section`
--

CREATE TABLE `tb_lms_courses_section` (
  `id_courses_section` int(255) NOT NULL,
  `id_courses` int(255) NOT NULL,
  `title` varchar(255) NOT NULL,
  `order` int(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data untuk tabel `tb_lms_courses_section`
--

INSERT INTO `tb_lms_courses_section` (`id_courses_section`, `id_courses`, `title`, `order`) VALUES
...
--
-- Struktur dari tabel `tb_lms_template`
--

CREATE TABLE `tb_lms_template` (
  `id_lms_template` int(255) NOT NULL,
  `name` varchar(255) NOT NULL,
  `path` varchar(255) NOT NULL,
  `status` enum('Active','No') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data untuk tabel `tb_lms_template`
--

INSERT INTO `tb_lms_template` (`id_lms_template`, `name`, `path`, `status`) VALUES
(1, 'Default - App', 'default-app', 'Active');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_lms_template_widget`
--

CREATE TABLE `tb_lms_template_widget` (
  `id_lms_template_widget` int(255) NOT NULL,
  `id_template` int(255) NOT NULL,
  `name` varchar(255) NOT NULL,
  `var` varchar(255) NOT NULL,
  `type` varchar(255) NOT NULL,
...
--
-- Struktur dari tabel `tb_lms_user_courses`
--

CREATE TABLE `tb_lms_user_courses` (
  `id_user_courses` int(255) NOT NULL,
  `id_user` int(255) NOT NULL,
  `id_courses` int(255) NOT NULL,
  `time` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Struktur dari tabel `tb_lms_user_lesson`
--

CREATE TABLE `tb_lms_user_lesson` (
  `id_user_lesson` int(255) NOT NULL,
  `id_user` int(255) NOT NULL,
  `id_courses` int(255) NOT NULL,
  `data` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Struktur dari tabel `tb_lms_user_payment`
--

CREATE TABLE `tb_lms_user_payment` (
  `id_user_payment` varchar(255) NOT NULL,
  `id_user` int(255) NOT NULL,
  `id_courses` int(255) NOT NULL,
...
--
-- Struktur dari tabel `tb_lms_user_review`
--

CREATE TABLE `tb_lms_user_review` (
  `id_user_review` int(255) NOT NULL,
  `id_courses` int(255) NOT NULL,
  `id_user` int(255) NOT NULL,
...
--
-- Struktur dari tabel `tb_lms_user_wishlist`
--

CREATE TABLE `tb_lms_user_wishlist` (
  `id_user_wishlist` int(255) NOT NULL,
  `id_user` int(255) NOT NULL,
  `id_courses` int(255) NOT NULL,
  `time` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data untuk tabel `tb_site`
--
...
--
-- Struktur dari tabel `tb_site_pages`
--

CREATE TABLE `tb_site_pages` (
  `id_site_page` int(255) NOT NULL,
  `title` text NOT NULL,
  `permalink` varchar(255) NOT NULL,
  `time` datetime NOT NULL,
  `updated` datetime DEFAULT NULL,
...
--
-- Dumping data untuk tabel `tb_site_pages`
--

INSERT INTO `tb_site_pages` (`id_site_page`, `title`, `permalink`, `time`, `updated`, `content`, `status`) VALUES
...
--
-- Struktur dari tabel `tb_site_visitor`
--

CREATE TABLE `tb_site_visitor` (
  `id_site_visitor` int(255) NOT NULL,
...
--
-- Dumping data untuk tabel `tb_site_visitor`
--

INSERT INTO `tb_site_visitor` (`id_site_visitor`, `ip`, `date`, `browser`, `os`, `country_name`, `country_code`, `hits`, `url`, `referrer`) VALUES
...
INSERT INTO `tb_user` (`id_user`, `username`, `password`, `headline`, `email`, `no_handphone`, `photo`, `grade`, `payment`, `created`, `last_login`, `status`) VALUES
...
(3, 'Riedayme', '7c4a8d09ca3762af61e59520943dc26494f8941b', '', 'programmer.irfaan@gmail.com', '21321321321', '', 'Instructor', '', '2020-05-03 20:01:58', '0000-00-00 00:00:00', 'UnActive');
...
--
-- Indeks untuk tabel `tb_blog_post`
--
...
--
-- Indeks untuk tabel `tb_blog_post_category`
--
...
--
-- Indeks untuk tabel `tb_blog_post_comment`
--
...
--
-- Indeks untuk tabel `tb_blog_post_tags`
--
ALTER TABLE `tb_blog_post_tags`
  ADD PRIMARY KEY (`id_blog_tags`),
  ADD KEY `slug` (`slug`);

--
-- Indeks untuk tabel `tb_blog_template`
--
...
--
-- Indeks untuk tabel `tb_blog_template_style`
--
ALTER TABLE `tb_blog_template_style`
  ADD PRIMARY KEY (`id_template_style`),
  ADD KEY `status` (`status`),
  ADD KEY `id_template` (`id_template`);

--
-- Indeks untuk tabel `tb_blog_template_widget`
--
ALTER TABLE `tb_blog_template_widget`
  ADD PRIMARY KEY (`id_template_widget`),
  ADD KEY `type` (`type`),
  ADD KEY `id_template` (`id_template`);
...
--
-- Indeks untuk tabel `tb_lms_category`
--
ALTER TABLE `tb_lms_category`
  ADD PRIMARY KEY (`id_lms_category`),
  ADD KEY `slug` (`slug`);

--
-- Indeks untuk tabel `tb_lms_coupon`
--
ALTER TABLE `tb_lms_coupon`
  ADD PRIMARY KEY (`id_lms_coupon`);

--
-- Indeks untuk tabel `tb_lms_courses`
--
ALTER TABLE `tb_lms_courses`
  ADD PRIMARY KEY (`id_lms_courses`),
  ADD KEY `permalink` (`permalink`),
  ADD KEY `time` (`time`),
  ADD KEY `status` (`status`),
...
--
-- Indeks untuk tabel `tb_lms_courses_lesson`
--
ALTER TABLE `tb_lms_courses_lesson`
  ADD PRIMARY KEY (`id_courses_lesson`);

--
-- Indeks untuk tabel `tb_lms_courses_section`
--
ALTER TABLE `tb_lms_courses_section`
  ADD PRIMARY KEY (`id_courses_section`);

--
-- Indeks untuk tabel `tb_lms_template`
--
ALTER TABLE `tb_lms_template`
  ADD PRIMARY KEY (`id_lms_template`),
  ADD KEY `status` (`status`);

--
-- Indeks untuk tabel `tb_lms_template_widget`
--
ALTER TABLE `tb_lms_template_widget`
  ADD PRIMARY KEY (`id_lms_template_widget`),
  ADD KEY `type` (`type`),
  ADD KEY `id_template` (`id_template`);

--
-- Indeks untuk tabel `tb_lms_user_courses`
--
ALTER TABLE `tb_lms_user_courses`
  ADD PRIMARY KEY (`id_user_courses`);

--
-- Indeks untuk tabel `tb_lms_user_lesson`
--
ALTER TABLE `tb_lms_user_lesson`
  ADD PRIMARY KEY (`id_user_lesson`);

--
-- Indeks untuk tabel `tb_lms_user_payment`
--
ALTER TABLE `tb_lms_user_payment`
  ADD PRIMARY KEY (`id_user_payment`);

--
-- Indeks untuk tabel `tb_lms_user_review`
--
ALTER TABLE `tb_lms_user_review`
  ADD PRIMARY KEY (`id_user_review`),
  ADD KEY `id_courses` (`id_courses`),
  ADD KEY `id_user` (`id_user`);

--
-- Indeks untuk tabel `tb_lms_user_wishlist`
--
ALTER TABLE `tb_lms_user_wishlist`
  ADD PRIMARY KEY (`id_user_wishlist`);

--
-- Indeks untuk tabel `tb_site`
--
ALTER TABLE `tb_site`
  ADD PRIMARY KEY (`type`);

--
-- Indeks untuk tabel `tb_site_pages`
--
ALTER TABLE `tb_site_pages`
  ADD PRIMARY KEY (`id_site_page`),
  ADD KEY `permalink` (`permalink`,`time`,`status`),
  ADD KEY `time` (`time`),
  ADD KEY `status` (`status`);

--
-- Indeks untuk tabel `tb_site_visitor`
--
ALTER TABLE `tb_site_visitor`
  ADD PRIMARY KEY (`id_site_visitor`),
  ADD KEY `ip` (`ip`),
  ADD KEY `date` (`date`),
  ADD KEY `hits` (`hits`),
  ADD KEY `url` (`url`);
...
--
-- AUTO_INCREMENT untuk tabel `tb_blog_post`
--
ALTER TABLE `tb_blog_post`
  MODIFY `id_post` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `tb_blog_post_category`
--
ALTER TABLE `tb_blog_post_category`
  MODIFY `id_post_category` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `tb_blog_post_comment`
--
ALTER TABLE `tb_blog_post_comment`
  MODIFY `id_post_comment` int(255) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tb_blog_post_tags`
--
ALTER TABLE `tb_blog_post_tags`
  MODIFY `id_blog_tags` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `tb_blog_template`
--
ALTER TABLE `tb_blog_template`
  MODIFY `id_template` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `tb_blog_template_style`
--
ALTER TABLE `tb_blog_template_style`
  MODIFY `id_template_style` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT untuk tabel `tb_blog_template_widget`
--
ALTER TABLE `tb_blog_template_widget`
  MODIFY `id_template_widget` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT untuk tabel `tb_jobs`
--
ALTER TABLE `tb_jobs`
  MODIFY `id_jobs` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `tb_lms_category`
--
ALTER TABLE `tb_lms_category`
  MODIFY `id_lms_category` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT untuk tabel `tb_lms_coupon`
--
ALTER TABLE `tb_lms_coupon`
  MODIFY `id_lms_coupon` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tb_lms_courses`
--
ALTER TABLE `tb_lms_courses`
  MODIFY `id_lms_courses` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `tb_lms_courses_lesson`
--
ALTER TABLE `tb_lms_courses_lesson`
  MODIFY `id_courses_lesson` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT untuk tabel `tb_lms_courses_section`
--
ALTER TABLE `tb_lms_courses_section`
  MODIFY `id_courses_section` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT untuk tabel `tb_lms_template`
--
ALTER TABLE `tb_lms_template`
  MODIFY `id_lms_template` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `tb_lms_template_widget`
--
ALTER TABLE `tb_lms_template_widget`
  MODIFY `id_lms_template_widget` int(255) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tb_lms_user_courses`
--
ALTER TABLE `tb_lms_user_courses`
  MODIFY `id_user_courses` int(255) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tb_lms_user_lesson`
--
ALTER TABLE `tb_lms_user_lesson`
  MODIFY `id_user_lesson` int(255) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tb_lms_user_review`
--
ALTER TABLE `tb_lms_user_review`
  MODIFY `id_user_review` int(255) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tb_lms_user_wishlist`
--
ALTER TABLE `tb_lms_user_wishlist`
  MODIFY `id_user_wishlist` int(255) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tb_site_pages`
--
ALTER TABLE `tb_site_pages`
  MODIFY `id_site_page` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT untuk tabel `tb_site_visitor`
--
ALTER TABLE `tb_site_visitor`
  MODIFY `id_site_visitor` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
