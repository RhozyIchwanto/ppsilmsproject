            ...
            <div class="c-card c-card--responsive u-p-zero">
                <div class="c-card__header c-card__header--transparent o-line">
                    ...
                    <?php if(!empty($blog_post)); ?>
                        <button class="u-ml-small c-btn c-btn--primary c-btn--custom" type="submit" name="save" title=>"save">
                    ...
                    <div class="u-ml-auto" style="min-width: 150px">
                        <div class="c-toggle u-mb-small">
                            <div class="c-toggle__btn <?php echo (!empty($site_pages['status'])) ? ($site_pages['status'] == 'Published') ? 'is-activate' : '':'is-activate' ?>">
